...
import express.static('uploads') from './uploads';
              ...
              <Route exact path="/">
                {user ? (
                  <React.Fragment>
                    ...
                    <div>
                      {" "}
                      Welcome to Smugglebook, the social network for smugglers{" "}
                    </div>
                  </React.Fragment>
                ) : (
                  <React.Fragment>
                    <div>
                      {" "}
                      Welcome to smugglebook, login to search for a smuggler{" "}
                    </div>
                  </React.Fragment>
                )}
                ...
                <React.Fragment>
                  <img
                    className="image"
                    src="https://www.yourdictionary.com/images/definitions/lg/14467.smuggle.jpg"
                    alt="Italian Trulli"
                  ></img>
                  <img
                    className="image"
